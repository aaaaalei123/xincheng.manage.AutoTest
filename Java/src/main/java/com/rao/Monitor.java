...
public class Monitor {
	public void pageRun() throws Exception {
		...
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div/div/div[2]/aside/ul/li[4]/ul/li[1]")).click();
		
		//条件查询
/*		Thread.sleep(3000);
		webdriver.findElement(By.cssSelector("input[placeholder='选择监控类型']")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[2]/div/div/ul/li")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[placeholder='设备序列号']")).sendKeys("224893996");
		Thread.sleep(1000);
...
/*		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[4]/div/div/ul/li")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[type='text'][placeholder='请输入摄像头名称']")).sendKeys("枪机1");
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[type='text'][placeholder='请输入摄像头序列号']")).sendKeys("C89110823");
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[type='text'][placeholder='请输入摄像头验证码']")).sendKeys("JXYFKJ");
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[type='text'][placeholder='是否开发查询']")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[5]/div/div/ul/li")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("input[type='text'][placeholder='请输入详细地址']")).sendKeys("1号路");
		Thread.sleep(1000);
		...
		//详情
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div/div/div[2]/section/div/div/div/div[2]/div/div[3]/table/tbody/tr/td[7]/div/button")).click();
		Thread.sleep(1500);
		...
		/*
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("button[type='button'][aria-label='Close'][class='el-message-box__headerbtn']")).click();*/
		//取消按钮
		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("button[type='button'][class='el-button el-button--default el-button--small']")).click();
		//确定按钮
/*		Thread.sleep(1000);
		webdriver.findElement(By.cssSelector("button[type='button'][class='el-button el-button--default el-button--small el-button--primary']"));*/
