...
public class Pick {
	public void pageRun() throws Exception {
		...
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div/div/div[2]/aside/ul/li[3]/ul/li[3]")).click();
		...
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[2]/div/div/ul/li[4]")).click();
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[3]/div/div/div/table/tbody/tr[2]/td[2]/div")).click();
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("/html/body/div[3]/div/div/div/table/tbody/tr[6]/td[4]/div")).click();
		Thread.sleep(1000);
		...
		//查看详情
		Thread.sleep(1000);
		webdriver.findElement(By.xpath("//*[@id='app']/div/div[2]/section/div/div/div/div[2]/div[1]/div[3]/table/tbody/tr[1]/td[8]/div/button")).click();
